//PO – zadania zadanie_5 <L2> <Damian Hanusiak> <17.11.2021>

//dodaæ setter i getter 
#include <iostream>
...
class samochod
{
	...
	public:
	//setter
	void setSpalanie(double s)
	{
		//sprawdzic czy wartosc jest poprawna
		if(s>0)
			spalanie=s;
		else
			std::cout << "Spalanie nie moze wynosic mniej niz 0!\n";
	}
...
int main()
{
	...
	switch(wybor_samochodu)
	{
		...
		while(wybor!=0)
		{
			...
			std::cout << "6.Prezentacja gettera\n";
			...
			switch(wybor)
			{
				...
				case 6: std::cout << s1.getSpalanie();
				break;
